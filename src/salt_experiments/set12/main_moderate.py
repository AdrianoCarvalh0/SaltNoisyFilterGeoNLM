...
from Salt_moderate_copy import generate_salt_experiment_moderate


if __name__ == '__main__':

    # Base output directory for the moderate salt-and-pepper noise experiment results
    root_dir_output_moderate = Path('/workspace/data/output/set12/salt_pepper_moderate/full_512')
