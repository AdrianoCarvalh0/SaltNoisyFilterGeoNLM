...
if __name__ == '__main__':
    ...
    root_dir_output_low = Path('/workspace/data/output/set50/salt_pepper_low/full_512')
    ...
    for subdir in ['NLM', 'GEONLM', 'MEDIAN', 'ASWMF', 'results']:
        (root_dir_output_low / subdir).mkdir(parents=True, exist_ok=True)
    ...
    parameters = {
        ...
        'dir_out_median': str(root_dir_output_low / 'MEDIAN'),
        'dir_out_aswmf': str(root_dir_output_low / 'ASWMF'),
        ...
        'name_pickle_results_gnlm_median_aswmf_output_low':
            'results_salt_pepper_gnlm_median_aswmf_low.pkl',
        'name_results_xlsx_nlm_gnlm_median_aswmf_output_low':
            'gnlm_median_aswmf_salt_pepper_low_filtereds.xlsx',
        ...
        # Use 3x3 for low-density impulse noise to avoid unnecessary smoothing.
        'median_size': 3,
