...
def generate_salt_experiment_moderate(parameters):
    ...
    The function:
      ...
      2. Adds moderate-level salt-and-pepper noise.
    ...
    array_nlm_moderate_filtereds = []

    # ---------------------------------------
    # 1) NLM PHASE — moderate SALT-AND-PEPPER NOISE
    # ---------------------------------------
    for file in array_dir:
        ...
        # Add moderate salt-and-pepper noise to create the noisy observation
        ...
        q_nlm_candidates = np.array([h_nlm + delta for delta in range(100, 200, 1)])
        ...
        array_nlm_moderate_filtereds.append(dct)
    ...
    save_pickle(array_nlm_moderate_filtereds, dir_out_results, name_pickle_nlm_output_moderate)

    # --------------------------------------------------
    # 2) MEDIAN, ASWMF, AND GEO-NLM PHASE — moderate SALT-AND-PEPPER NOISE
    # --------------------------------------------------
